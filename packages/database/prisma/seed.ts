...
/**
 * Génère une clé API au format ll_xxxx
 */
...
async function main() {
  ...
  // ============================================
  // 4. Ajouter les membres au projet
  // ============================================
  ...
  const createdEnvironments: Record<string, any> = {};
  ...
  for (const flagData of flags) {
    ...
    // Créer les états par environnement
    ...
    // Créer les variants si c'est un flag MULTIVARIATE
  ...
  // Mettre à jour le compteur de flags
  ...
  // ============================================
  // 9. Créer quelques entrées d'audit
  // ============================================
