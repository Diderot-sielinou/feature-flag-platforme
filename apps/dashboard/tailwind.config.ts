...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      // ========================================
      // COLOR PALETTE - LaunchLayer Brand
      // ========================================
      colors: {
        // Brand Colors
        obsidian: {
      ...
      backgroundImage: {
        ...
        'gradient-brand-soft': 'linear-gradient(135deg, #E19547 0%, #D17303 100%)',
        'gradient-dark': 'linear-gradient(180deg, #0E0503 0%, #180F0E 100%)',
        ...
        'dots-pattern': "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%239C92AC' fill-opacity='0.1'%3E%3Ccircle cx='3' cy='3' r='1'/%3E%3C/g%3E%3C/svg%3E\")",
      },
